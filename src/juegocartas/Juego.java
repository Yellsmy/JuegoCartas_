...
public class Juego  extends Baraja
{
    ...
    { 
        String carta = repartirCarta();// primera carta a asignar
        double puntosCarta= valorCartaRepartida(carta,tipoMazo); //obtenemos el valor de la carta asignada
    ...
    public String repartirCarta()
    {
        ...
        String cartaRepartida="";//almacena una carta asignada de forma aleatoria
        ...
        for (int i = 0; i < 1; i++)//realizaa la asignacion de carta una vez por jugador
        {
            if(i >= mazoBarajeado.size())// validamos que el valor tamaño del mazo sea almenos de 1 carta para poder asignarla 
            {
                ...
                try
                {
                    ...
                    cartaRepartida=mazoBarajeado.get(mazoBarajeado.size()-1).toString(); //obtenemos una carta del mazo
            ...
            {
                cartaRepartida=mazoBarajeado.get(i).toString();  //obtenemos una carta del mazo
                System.out.println("\033[36mBANCA REPARTE LA CARTA "+cartaRepartida); // la Banca muestra la carta a los jugadores 
        ...
        while(continuar){
            ...
            for (int i = 0; i < indiceJugador.length; i++)
            {
                ...
                if(pedirCarta==1)// validacion si la opcion es 1 
                {
                    ...
                    valorCarta=valorCartaRepartida(cartaRepartida,tipoMazo); //obtenemos el valor de la carta asignada
